...
const socials = [
  ...
  {width:18, height:18,name:'instagram',path:"M12.375 0H5.625C4.13316 0 2.70242 0.592632 1.64752 1.64752C0.592632 2.70242 0 4.13316 0 5.625L0 12.375C0 13.8668 0.592632 15.2976 1.64752 16.3525C2.70242 17.4074 4.13316 18 5.625 18H12.375C13.8668 18 15.2976 17.4074 16.3525 16.3525C17.4074 15.2976 18 13.8668 18 12.375V5.625C18 4.13316 17.4074 2.70242 16.3525 1.64752C15.2976 0.592632 13.8668 0 12.375 0V0ZM16.3125 12.375C16.3125 14.5463 14.5463 16.3125 12.375 16.3125H5.625C3.45375 16.3125 1.6875 14.5463 1.6875 12.375V5.625C1.6875 3.45375 3.45375 1.6875 5.625 1.6875H12.375C14.5463 1.6875 16.3125 3.45375 16.3125 5.625V12.375Z",path2:"M9 4.5C7.80653 4.5 6.66193 4.97411 5.81802 5.81802C4.97411 6.66193 4.5 7.80653 4.5 9C4.5 10.1935 4.97411 11.3381 5.81802 12.182C6.66193 13.0259 7.80653 13.5 9 13.5C10.1935 13.5 11.3381 13.0259 12.182 12.182C13.0259 11.3381 13.5 10.1935 13.5 9C13.5 7.80653 13.0259 6.66193 12.182 5.81802C11.3381 4.97411 10.1935 4.5 9 4.5ZM9 11.8125C8.25435 11.8116 7.5395 11.515 7.01225 10.9878C6.485 10.4605 6.18839 9.74565 6.1875 9C6.1875 7.44863 7.44975 6.1875 9 6.1875C10.5503 6.1875 11.8125 7.44863 11.8125 9C11.8125 10.5503 10.5503 11.8125 9 11.8125Z",path3:"M13.8374 4.76212C14.1686 4.76212 14.437 4.49366 14.437 4.16249C14.437 3.83133 14.1686 3.56287 13.8374 3.56287C13.5063 3.56287 13.2378 3.83133 13.2378 4.16249C13.2378 4.49366 13.5063 4.76212 13.8374 4.76212Z"},
      ...
      <div className='container mx-auto pt-14 '>
        <div className=' flex flex-col text-white  gap-12 lg:flex-row'>
          <div className='mx-auto mb-6 gap-4 flex-col flex justify-between max-w-[285px] flex-1 lg:mx-0'>
            <FooterLogo />
            <div className='flex flex-row gap-2 justify-start lg:w-[50%] '>
              {socials.map((a) => (
                <SocialLogo height={a.height} width={a.width} d={a.path} d2={a.path2} d3={a.path3} key={a.name} />
              ))}
            </div>
          </div>
          <div className='flex flex-1 justify-center flex-col gap-16 p-2 md:flex-row'>
            ...
            <div className='w-full flex justify-center flex-col items-center lg:items-start text-center lg:text-left'>
              <div className={`footerLinks mb-6`}>About us</div>
              <ul className={`footerSublinks space-y-4`}>
                <li>
                  <a className='hover:text-blue transition' href='/'>
                    Roadmap
            ...
            <div className='w-full flex justify-center flex-col items-center lg:items-start text-center lg:text-left'>
              <div className={`footerLinks mb-6`}>Places</div>
              <ul className={`footerSublinks space-y-4`}>
                <li>
                  <a className='hover:text-blue transition' href='/'>
                    Castle
